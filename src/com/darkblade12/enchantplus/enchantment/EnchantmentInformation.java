...
public enum EnchantmentInformation {
	...
	LOOT_BONUS_BLOCKS(
			...
			"For redstone, carrots, glowstone, melons, nether wart, and wheat (seeds only), each level increases the drop maximum by +1 (maximum 4 for glowstone and 9 for melons)", "For tall grass, each level increases the drop maximum by +2"),
	...
	private EnchantmentInformation(String minecraftName, String... description) {
	...
	public static String getMinecraftName(Enchantment enchantment) {
		EnchantmentInformation information = fromEnchantment(enchantment);
		return information == null ? "Unknown" : information.getMinecraftName();
	}

	public static String[] getDescription(Enchantment enchantment) {
		EnchantmentInformation information = fromEnchantment(enchantment);
		return information == null ? new String[] { "No description set for this enchantment!" } : information.description;
	}
}